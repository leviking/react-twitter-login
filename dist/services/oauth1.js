...
var proxyUrl = process.env.PROXY_URL || "https://cors-anywhere.herokuapp.com/";
...
exports.obtainOauthRequestToken = function (_a) {
    var signature = _a.signature, consumerKey = _a.consumerKey, consumerSecret = _a.consumerSecret, callbackUrl = _a.callbackUrl, method = _a.method, apiUrl = _a.apiUrl;
            ...
            switch (_b.label) {
                case 0:
                    oauthSignature = signature ||
                        signature_1.requestTokenSignature({
                            method: method,
                            apiUrl: apiUrl,
                    ...
                    return [4, fetch("" + proxyUrl + apiUrl, {
                            method: method,
                            headers: {
